...
export default function SortProductList({ queryConfig, pageSize }: PropsType) {
    ...
    //exclude loai bo gia tri nao do cua type
    ...
    const handlerPriceOrder = (orderValue: Exclude<ProductListConfig['order'], undefined>) => {
        navigate({
            pathname: path.home,
            search: createSearchParams({
                ...queryConfig,
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <select
                        ...
                        value={order || ''}
                        onChange={(event) =>
                            handlerPriceOrder(event.target.value as Exclude<ProductListConfig['order'], undefined>)
                        }
                    >
